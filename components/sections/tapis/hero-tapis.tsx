  ...
  return (
    <>
      ...
      <p className="mt-5 max-w-xl text-pretty text-base leading-relaxed text-white/80 lg:text-lg">
        <span className="text-2xl font-bold text-primary">Des {formatPrice(startingFrom("tapis"))}</span>
        <span className="ml-2">— Laine, synthétique, oriental. Couleurs ravivées, fibres assainies.</span>
      </p>
