...
export function Footer() {
  return (
    <footer className="bg-muted pb-24 md:pb-0">
      <div className="mx-auto max-w-7xl px-4 py-12 lg:px-8">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="mt-4 text-sm leading-relaxed text-muted-foreground">
              Expert en nettoyage textile à domicile en Île-de-France. Nous redonnons vie à vos
              textiles.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3">
              ...
              <li>
                <a
                  href="mailto:contact@saficlean.fr"
                  className="flex items-center gap-2 text-sm text-muted-foreground transition-colors hover:text-primary"
                >
                  <Mail className="h-4 w-4 flex-shrink-0 text-primary" />
                  contact@saficlean.fr
                </a>
              </li>
            </ul>
          </div>
        ...
        <div className="mt-12 border-t pt-8">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:justify-center sm:gap-6 text-xs">
            ...
            <Link href="/politique-confidentialite" className="text-muted-foreground transition-colors hover:text-primary">
